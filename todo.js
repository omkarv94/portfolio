...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                      <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.png" class="todo-controls1"/>
                      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="delete.png" class="todo-controls" />
                      </div></div>`;
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${
        style === "" ? '<img class="edit todo-controls1" onclick="UpdateToDoItems(this)" src="pencil.png" />': ""
      }
