...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      const todoItems = `<div style="background-color: green" title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                      <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.png" style="width: 33px; height: 33px; margin: 0; padding: 0"/>
                      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="delete.png" style="width: 33px; height: 33px; " />
                      </div></div>`;
